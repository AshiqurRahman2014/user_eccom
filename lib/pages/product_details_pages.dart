...
import 'package:user_ecomm/uitls/widegt_function.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
                  ...
                  OutlinedButton(
                    onPressed: () async {
                      ...
                      if (AuthService.currentUser!.isAnonymous) {
                        ...
                        EasyLoading.dismiss();
                        focusNode.unfocus();
                        showMsg(context, 'Thanks for your comments. Your comment is waiting for admin approval');
                      }
                    },
                    child: const Text('SUBMIT'),
                  )
          ...
          Padding(
            padding: const EdgeInsets.all(8),
            child: Text('All omments',style: Theme.of(context).textTheme.subtitle1,),
            ...
            builder: (context, snapshot){
              if(snapshot.hasData){
                ...
                if(commentList.isEmpty){
                  return const Center(child: Text('No comments founds'),);
                }else{
                  return Column(
                    ...
                    children: commentList.map((comment) => Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          const Icon(Icons.person) : CachedNetworkImage(
                            width: 70,
                            height: 100,
                            fit: BoxFit.fill,
