...
import 'package:user_ecomm/pages/user_profile_page.dart';

import '../curstomwidegt/cart_bubble_view.dart';
import '../curstomwidegt/main_drawer.dart';
import '../curstomwidegt/product_grid_item_view.dart';
import '../models/catagory_model.dart';
import '../provider/cart_provider.dart';
import '../provider/order_provider.dart';
import '../provider/product_provider.dart';
import '../provider/user_provider.dart';
import '../uitls/notification_services.dart';
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (message.notification != null) {
       // print('Message also contained a notification: ${message.notification}');
        ...
        notificationServices.sentNotification(message);
      }
    });
